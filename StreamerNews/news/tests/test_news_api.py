...
#                 news_client = self.client.get(self.url,
#                                               {"Authorization": token})
...
#         for token, code in self.TOKENS_GET.items():
#             with self.subTest(f'{token}:{code}'):
#                 news_client = self.client.get(self.url + "1/",
#                                               {"Authorization": token})
#                 self.assertEqual(news_client.status_code, code)
...
#         self.assertEqual(
#             News.objects.get(pk=3).title,
#             'title_new_news'
#         )
#         self.assertEqual(
#             News.objects.get(pk=4).title,
#             'title_new_news'
#         )
#         self.assertEqual(
#             News.objects.get(pk=3).content,
#             'content_new_news',
#         )
#         self.assertEqual(
#             News.objects.get(pk=4).content, 'content_new_news')
#         self.assertEqual(
#             News.objects.get(pk=3).category.pk, 1)
#         self.assertEqual(
#             News.objects.get(pk=4).category.pk, 1)
#
